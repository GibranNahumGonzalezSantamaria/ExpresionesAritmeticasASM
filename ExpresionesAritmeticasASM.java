...
public class ExpresionesAritmeticasASM {
    ...
    private static boolean esExpresionValida(String expresion) {
        ...
        // Validar que los paréntesis estén correctamente precedidos por operadores
        ...
        // Verificar que no haya números seguidos de identificadores
        ...
        // Verificar que haya exactamente un '=' en la expresión
        ...
        // Verificar que la variable del lado izquierdo no aparezca en el lado derecho
        ...
        // Verificar que no haya caracteres no permitidos en la expresión
        ...
        // Verificar que no se usen palabras reservadas en la expresión
        ...
        // Verificar que el número de paréntesis sea balanceado
